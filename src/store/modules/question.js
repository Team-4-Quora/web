...
const actions = {
  ...
  async addQuestion ({commit}, {questionBy, text, category}) {
    ...
    axios.post('http://10.177.1.74:8081/qna/question/add', {
  ...
  async getByCategory ({commit}, {categ}) {
    ...
    const response = await axios.get(`http://10.177.1.74:8081/qna/question/fetch/category/${categ}`)
  ...
  async getByOrgId ({commit}, {orgid}) {
    ...
    const response = await axios.get(`http://10.177.1.74:8081/qna/question/fetch/orgId/${orgid}`)
  ...
  async getByMail ({commit}, {mail}) {
    ...
    const response = await axios.get(`http://10.177.1.74:8081/qna/question/fetch/questionBy/${mail}`)
